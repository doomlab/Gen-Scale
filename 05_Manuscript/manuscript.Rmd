...
internal consistency ($\alpha$ = .91) and test-retest reliability
was *r* = .97. Internal consistency of subscales for the five
...
-   try running with outliers as well --\> if differences: then talk
...
random = rchisq(nrow(noout[ , 37:97]), 7) fake = lm(random\~.,
data=noout[ , 37:97])
