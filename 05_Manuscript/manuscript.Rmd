...
- import the edited files and test those models for fit 
- theory is 5, so if the fit is similar, then go with five 

--- 
test cfa 
test MGCFA --> use new package to include information 
--- 
