...
58 items were developed using previous scale
...
and the survey was completed in \emph{M} =
6.34 (\emph{SD} =
4.85 minutes.{]}.
...
Steiger (2016){]}, Root Mean Squared Residual {[}RMSR; Jöreskog and Sörbom (1996){]},
Comparative Fit Index {[}CFI; Bentler (1990){]}, and the Tucker-Lewis Index
{[}TLI; Tucker and Lewis (1973){]}. Values close to one are expected for goodness of fit
statistics {[}CFI, TLI; Bentler (1990); Hu and Bentler (1999){]}, while lower values close
...
Data were screened for accuracy, missing data, outliers, and multivariate parametric assumptions. The undergraduate data included \emph{n} = 564 participants. We first screened each participant for missing data and excluded \emph{n} = 7 participants for missing more than 5\% of their data {[}TABACHNICK{]}. 105 participants included less than 5\% missing data (i.e., 3 items or less), and these data points amounted to less than 2\% of data missing per question. These items were replaced with a random imputation from the \emph{mice} library {[}CITE MICE{]}.

The data were then screen for attentiveness and accuracy using the framework from CITE BUCHANAN to find low quality responses. The survey items were split into three pages, and each page was screened separately using click counts, an attention check item (i.e., please answer strongly agree for this item), and number of characters on a page for reading speed. The total number of indicators for low quality data was summed for each participant across pages (e.g., 3 indicators by 3 pages = 9 total possible items), and \emph{n} = 49 participants showed at least 4 indicators across all pages. CITE BUCHANAN suggest a criteria of 2/5 screeners or 40\%, and therefore, we used 4 items as the \textasciitilde40\% cut off for inclusion in the data. The final sample size for the undergraduate population was \emph{n} = 508. We additionally screened for multivariate outliers using Mahalanobis distance across items and found \emph{n} = 43 possible outliers, but they are included in the analyses described below.

\subsubsection{Mechanical Turk Data}\label{mechanical-turk-data}

The Mechanical Turk data were screened in the same manner as the undergraduate sample. The original sample size was \emph{n} = 240 participants. \emph{N} = 23 participants were excluded for missing more than 5\% of their data, and \emph{n} = 36 participants had 3 or less data points estimated using the \emph{mice} library. The same low quality data screening was performed, and \emph{n} = 20 participants were excluded for having 40\% or more low quality indicators. Last, \emph{n} = 10 participants were flagged as potential outliers but were not included in analyses presented below.
...
The data was then randomly split into \emph{n} = 352 participants for the exploratory factor analysis, and \emph{n} = 353 for the confirmatory factor analysis. The EFA data included \emph{n} undergraduate = 254 participants, and \emph{n} Mechanical Turk = 98 participants. The CFA data included \emph{n} undergraduate = 254 participants, and \emph{n} Mechanical Turk = 99 participants.

\subsection{EFA}\label{efa}

\subsubsection{Number of Factors}\label{number-of-factors}

To determine the number of factors that best fit the data, we used suggested theory (5 factors), a scree plot, and a parallel analysis using the \emph{psych} library {[}CITE PSYCH{]}. Parallel analysis suggested 7 factors, while a visual inspection of the scree plot indicated 2 to 3 factors. We analyzed a 2-factor, 3-factor, and 5-factor model for simple structure and fit indices.

\subsubsection{Simple Structure}\label{simple-structure}

The 58 items were first tested with a 2-factor fit, and 7 items were excluded for not loading on any factor or loading on multiple factors with a loading greater than .30. After removing these items, all items loaded cleanly on the two factors. The loading table for this analysis can be found at XX. This same procedure was repeated for the 3-factor fit, and 10 items were removed from the first round of analysis, and 1 item was removed from the second round of analysis, resulting in a final set of 47 items. The loading table and items can be found at XX. Last, the 5-factor model showed 15 poor items on the first round of analysis, and 10 poor items on the second round of analysis, resulting in a final set of 33 items for the final model. The items and loadings can be found at XX.

We then compared items across all factor models to reduce scale length. Items were selected for the final model if they: 1) theoretically made sense with the other items on that factor, 2) loaded on the theorized 5-factor model (i.e., items were included in the 2-factor model if they also had been included in the 5-factor model), and 3) were not face-value redundant with other items on that factor. We tested these items and found that the 2-factor and 3-factor models continued to show simple structure, but the 5-factor model required the removal of 2 more items due to cross loadings across factors. To select the best model, we examined the fit indices for each factor structure. The 5-factor model showed the best fit (RMSEA = .038, RMSR = .024, TLI = .968, CFI = .982), followed by the 3-factor model (RMSEA = .049, RMSR = .028, TLI = .962, CFI = .977), and then the 2-factor model (RMSEA = .062, RMSR = .031, TLI = .963, CFI = .977). The final factor loadings for the 5-factor scale are shown in Table \ref{tab:table-five-factor}, and the other loadings can be found at XX (2-factor) and XX (3-factor).
...
\caption{\label{tab:table-five-factor}}

\begin{tabular}{llllll}
\toprule
Spiritual & Social & Personal & Biological & Physical & Item\\
\midrule
0.93 & -0.04 & 0.00 & 0.02 & -0.01 & I believe in an afterlife.\\
0.91 & 0.03 & 0.00 & -0.02 & 0.00 & My spirit or soul will live on after I physically die.\\
0.83 & -0.01 & -0.04 & -0.01 & 0.07 & I believe in an immaterial soul or spirit.\\
0.82 & 0.01 & 0.04 & 0.04 & 0.00 & Death is not the end.\\
0.51 & 0.15 & 0.07 & -0.03 & -0.12 & The ideologies I believe in such as my religion, philosophies or politics will live on.\\
0.01 & 0.79 & 0.08 & -0.08 & -0.07 & I have taken part in activities or events which will impact the future.\\
-0.05 & 0.76 & 0.00 & 0.03 & 0.15 & I have contributed to the world in a unique way.\\
0.02 & 0.73 & -0.06 & 0.12 & -0.05 & I have contributed to things which will be meaningful.\\
0.06 & 0.65 & 0.04 & -0.06 & 0.16 & My life has influenced the world.\\
0.12 & 0.59 & 0.08 & 0.10 & -0.17 & I feel I have taken part in something bigger than myself.\\
0.13 & 0.35 & 0.07 & 0.22 & 0.13 & I believe I will be remembered for a long time after I die.\\
0.00 & -0.02 & 1.02 & -0.02 & 0.03 & Parts of my personality have rubbed off on other people.\\
0.03 & 0.08 & 0.69 & 0.11 & -0.02 & Through my interactions with them, others have picked up parts of my personality.\\
-0.06 & 0.29 & 0.35 & 0.17 & -0.11 & I have imparted knowledge and skills on to others.\\
0.03 & -0.03 & -0.04 & 0.76 & 0.04 & My offspring carry parts of me with them.\\
0.02 & 0.02 & 0.08 & 0.73 & 0.00 & I am comforted by the fact that my genes can/will be carried on in the future.\\
0.08 & 0.11 & 0.14 & 0.44 & -0.10 & I am comforted by knowing my loved ones will live on after me.\\
-0.05 & 0.18 & -0.05 & 0.35 & 0.20 & I have children or students which take after me.\\
-0.01 & 0.01 & -0.01 & 0.05 & 0.75 & I believe will not die.\\
-0.01 & -0.01 & 0.10 & 0.01 & 0.60 & I have a hard time believing I will physically die.\\
0.13 & 0.03 & -0.02 & -0.01 & 0.62 & I don't entirely believe I will die.\\
0.07 & 0.04 & 0.07 & -0.02 & 0.47 & I believe I will be reincarnated.\\
\bottomrule
\end{tabular}
...
Using the multigroup CFA procedure described above, we examined the 5-factor model for overall fit and fit across groups. Table \ref{tab:cfa-model-fit} portrays the results of the assessment of all models. The model showed acceptable fit overall with lower than desired values on the TLI, and lower values on the CFI and TLI for each individual group. Model fit appeared acceptable to investigate multi-group structure when examining the configural model with good values for the residual fit statistics, and poorer values for the goodness of fit statistics. We examined for potential areas of misfit using modification indices but did not find any suggested correlated error terms (i.e., two similar items that have related residuals) or cross-loadings that fit within theoretical structure. Therefore, we did not make any modifications.

Using the \(\Delta\)CFI \(\le\) .01 rule for degradation in fit, we found that the loadings (\emph{scalar}) showed invariance across groups, while a large degradation in fit was found between the loadings and intercepts (\emph{metric}). We individually removed the equality constraint between groups for each item, and found one item that was different between groups: \emph{I have children or students which take after me.} The intercept for the undergraduate sample on this item was: 2.26, \emph{SE} = 0.08, while the Mechanical Turk sample showed a higher average item score: 3.45, \emph{SE} = 0.12. Figure \ref{fig:visualize-diffs} demonstrates a visualization of those differences with higher intercepts for the Mechanical Turk group. The overall distribution for the biological factor is also displayed in this figure.
...
Residuals & 914.583 & 97 & 0.855 & 0.852 & 0.076 & 0.085\\
\bottomrule
\end{tabular}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-latex/visualize-diffs-1.pdf}}
...
\begin{verbatim}
## # A tibble: 37 x 47
##    free.parameter npar       fmin       chisq      df      pvalue baseline.chisq
##    <chr>          <lvn.vctr> <lvn.vctr> <lvn.vctr> <lvn.v> <lvn.> <lvn.vctr>    
##  1 Q2_13 ~~ Q2_13 97         1.382986   976.3883   453     0      3650.446      
##  2 Q5_12 ~~ Q5_12 97         1.382640   976.1440   453     0      3650.446      
##  3 Q4_11 ~~ Q4_11 97         1.381266   975.1736   453     0      3650.446      
##  4 Q4_18 ~~ Q4_18 97         1.382443   976.0046   453     0      3650.446      
##  5 Q4_8 ~~ Q4_8   97         1.378295   973.0765   453     0      3650.446      
##  6 Q2_19 ~~ Q2_19 97         1.378511   973.2288   453     0      3650.446      
##  7 Q5_17 ~~ Q5_17 97         1.377931   972.8194   453     0      3650.446      
##  8 Q5_18 ~~ Q5_18 97         1.366113   964.4759   453     0      3650.446      
##  9 Q2_20 ~~ Q2_20 97         1.383588   976.8129   453     0      3650.446      
## 10 Q2_9 ~~ Q2_9   97         1.383783   976.9511   453     0      3650.446      
## # i 27 more rows
## # i 40 more variables: baseline.df <lvn.vctr>, baseline.pvalue <lvn.vctr>,
## #   cfi <lvn.vctr>, tli <lvn.vctr>, nnfi <lvn.vctr>, rfi <lvn.vctr>,
## #   nfi <lvn.vctr>, pnfi <lvn.vctr>, ifi <lvn.vctr>, rni <lvn.vctr>,
## #   logl <lvn.vctr>, unrestricted.logl <lvn.vctr>, aic <lvn.vctr>,
## #   bic <lvn.vctr>, ntotal <lvn.vctr>, bic2 <lvn.vctr>, rmsea <lvn.vctr>,
## #   rmsea.ci.lower <lvn.vctr>, rmsea.ci.upper <lvn.vctr>, ...
\end{verbatim}
